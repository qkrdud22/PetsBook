			...
			<div class="row">
				<div class="col-lg-12 text-center">
					<form action="${pageContext.request.contextPath}/admin/deleteOK"
						...
						<table>
							<tr>
								<td colspan="2" class="title">소통공간 삭제하기</td>
							</tr>
							<c:forEach var="vo" items="${list }" varStatus="vs">
								...
								<tr>
									...
									<td><input type="radio" name="tableName"
										value="${vo.tableName }"> <input type="hidden"
										name="boardName" value="${vo.boardName }" /> <input
										type="hidden" name="boardInfo" value="${vo.boardInfo }" /></td>
								</tr>
							</c:forEach>
							<tr>
								<td colspan="2" style="border: none; text-align: right;">
									<button class="btn btn-success btn-sm"
										onclick='post_to_url("${pageContext.request.contextPath }/admin/delete",{})'>소통공간
										삭제하기</button>
								</td>
							</tr>
						</table>
