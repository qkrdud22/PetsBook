...
<body style="background-color: #ece6cc;">
	...
	<!-- navigation 종료 -->
	<form action="mainupdateOk" method="post" onsubmit="return formCheck();"
				...
				<div class="row">
					<div class="col-lg-12 text-center">
						<table style="border: 1px; text-align: center;">
							<tr>
								<td colspan="4" class="title">타임라인 수정하기</td>
							</tr>
							<tr>
							...
							<tr>
								<td colspan="4" align="right" style="padding-right: 120px;">
									...
									onclick='post_to_url("${pageContext.request.contextPath }/home",{"idx":${vo.idx }, "m":"0", "p":${commVO.currentPage },"s":${commVO.pageSize},"b":${commVO.blockSize }})'>
								</td>
							</tr>
						</table>
					</div>
