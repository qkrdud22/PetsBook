...
<body style="background-color: #ece6cc;">
	...
	<!-- navigation 종료 -->
	<form action="maindeleteOk" method="post" onsubmit="return formCheck();">
		<%-- 몇가지는 숨겨서 가자!!! --%>
				...
				<div class="row">
					<div class="col-lg-12 text-center">
						<table style="border: 1px; text-align: center;">
							<tr>
								<td colspan="4" class="title">타임라인 글삭제</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<img
								 ...
								 <textarea rows="10" cols="80"
										name="content" readonly="readonly">${vo.content }</textarea></td>
							</tr>
							<tr>
								<td colspan="4" align="right" style="padding-right: 120px;">
									...
									onclick='post_to_url("home",{"idx":${vo.idx },"m":"0", "p":${commVO.currentPage },"s":${commVO.pageSize},"b":${commVO.blockSize }})'>
								</td>
							</tr>
						</table>
					</div>
