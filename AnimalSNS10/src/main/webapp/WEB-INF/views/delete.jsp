...
<head>
<meta charset="UTF-8">
<title>${commVO.tableName}글삭제</title>
<!-- Bootstrap core CSS -->
						...
						<table style="border: 1px; text-align: center;">
							...
							<tr>
								...
								<td align="left" colspan="3"><input type="text"
									name="subject" id="subject" readonly="readonly" size="78"
									value="${vo.subject }"></td>
							</tr>
							<tr>
							...
							<tr>
								<td colspan="4" align="right" style="padding-right: 120px;">
									...
									onclick='post_to_url("view",{"tb":"${commVO.tableName}","idx":${vo.idx },"m":"0", "p":${commVO.currentPage },"s":${commVO.pageSize},"b":${commVO.blockSize }})'>
								</td>
							</tr>
						</table>
					</div>
